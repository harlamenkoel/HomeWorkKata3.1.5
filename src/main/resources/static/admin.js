...
allUsers.then(users => {
        ...
        for (const i in users) {
            ...
            result += `<tr>
                    ...
                    <td>${roles}</td>
                    <td>
                        <button type="button" class="btn btn-info btn-sm text-white" id="editUserBtn"}">Изменить</button>
                    </td>
                    <td>
                        <button type="button" class="btn btn-danger btn-sm" id="deleteUserBtn">Удалить</button>
                    </td>
                    </tr>`;
        }
    ...
    fetch(urlUsers, {
        ...
        .then(user => {
            ...
            newRow.innerHTML = `<tr>
                           ...
                           <td><button type="button" class="btn btn-info btn-sm text-white" id="editUserBtn">Изменить</button></td>
<td><button type="button" class="btn btn-danger btn-sm" id="deleteUserBtn">Удалить</button></td>
                           </tr>`;
